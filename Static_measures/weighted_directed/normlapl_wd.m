function [normdiplacian, normsymlap, normsksymlap]= normlapl_wd(mat, alpha)
...
normdiplacian= aux*(eye(size(P, 2))-P)*aux2;
normsymlap= 0.5.*(normdiplacian+ normdiplacian'); % Symmetric Laplacian
normsksymlap= 0.5.*(normdiplacian- normdiplacian'); % Skew-Symmetric Laplacian
