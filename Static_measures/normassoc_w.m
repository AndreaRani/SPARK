function normas= normassoc_w(mat, labA, labB)

% Given a weighted graph G(V, E), the normalized association of a subset of nodes
...
% Association
[assocA, assocB]= assoc_w(newmat, hA, hB); 
