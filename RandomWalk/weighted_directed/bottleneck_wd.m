function [bott_A, bott_B]= bottleneck_wd(mat, alpha, labA, labB)
...
[QA2B, QB2A, Qleave]= Qleave_wd(newmat, hA, hB, alpha); % One-step probability to leave the partition @stationary state
statprob= stprob_wd(newmat, hA, hB, alpha);
