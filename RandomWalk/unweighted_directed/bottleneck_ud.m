function [bott_A, bott_B]= bottleneck_ud(mat, alpha, labA, labB)
...
[QA2B, QB2A, Qleave]= Qleave_ud(newmat, hA, hB, alpha); % One-step probability to leave the partition @stationary state
statprob= stprob_ud(newmat, hA, hB, alpha);
