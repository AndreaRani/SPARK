function [QA2B, QB2A, Qleave]= Qleave_wu(mat, labA, labB, alpha)
...
% of a random walker to leave its starting vertex subset in one step once 
% reached the stationarity, is the sum of all leaving probabilities of the
% updated probability matrix newP= diag(Wp)*P.
...
P= probt_wu(newmat, alpha);
statprob= stprob_wu(newmat, alpha);
