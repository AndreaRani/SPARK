function [bott_A, bott_B]= bottleneck_wu(mat, alpha, labA, labB)
...
[QA2B, QB2A, Qleave]= Qleave_wu(newmat, hA, hB, alpha); % One-step probability to leave the partition @stationary state
statprob= stprob_wu(newmat, hA, hB, alpha);
